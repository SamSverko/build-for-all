<p>The current business case is that startups can increase their reach, and subsequently their profitability, if they are inclusive. Accessibility also improves: SEO, usability, use by aging populations, reduced website costs (this is through reducing bugs and interoperability issues), and increased efficiency of the site through reduced bandwidth. If websites are inaccessible complaints and lawsuits can also be filed against them on the grounds of discrimination or unequal access.</p>

<p class="font-bold">Why Web Accessibility?</p>
...
<p><b>Marcela Correa Villada, ATP.</b><br>
