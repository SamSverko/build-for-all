...
<p><b>Auditing:</b> Checking your website, product, or service in various ways to make they meet accessibility criteria.</p>
...
<p><b>Usability and User Experience:</b> The ability for the user, individual using your site, product, or service, to reach their objective effectively through intelligent design.</p>

<p><b>W3C:</b> World Wide Web Consortium. W3C is a community focussed on developing international web standards and make the most out of the power of internet for everyone.</p>

<p><b>WAI:</b> Web Accessibility Initiative. WAI is run through the W3C (World Wide Web Consortium) with a focus on creating equal opportunities online for individuals with disabilities. The WAI creates support materials that enable the user to understand online accessibility.</p>

<p><b>WCAG 2.0:</b> Web Content Accessibility Guidelines version two (2). Created through the W3C’s WAI, WCAG 2.0 is a set of technical standards for accessibility online. WCAG 2.0 has leveled tiers of accessibility standards, the lowest acceptable standard being Level A, the next being Level AA, and the highest level of accessibility being Level AAA.</p>

<p><b>Zoom:</b> Zoom is an accessibility feature created by Apple that allows users to magnify an image on their Mac, iPad, or iPhone. Zoom can be setup through the accessibility panel on these devices.</p>
