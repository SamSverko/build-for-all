...
<code tabindex="0">
  ...
  <p tabindex="0">Please note you can style the <code>#skiptocontent</code> focus link in a way that matches your website’s aesthetic and branding, just keep in mind <a href="http://localhost:8888/build-for-all/content-page.php?article=3" target="_self">contrast and text visibility</a>.</p>

  <p tabindex="0" class="font-bold">Caution:</p>

  <p tabindex="0">If you make the link entirely invisible, and only accessible to screen readers, those that have limited fine motor skills or use assistive technology to access websites will have to navigate through the long navigational menu to access your content.
    ...
    <p tabindex="0">This technique can also be used to skip over repetitive information.</p>
