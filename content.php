...
if (get_latest_post()) {
  ...
  if (get_author_picture($latest_post[0]->author)) {
    // assign author image src to variable
    $author_src = get_author_picture($latest_post[0]->author);
...
<div class="container-fluid contain-to-1000 content-section-1">
  ...
  <div class="row">
    <div class="col-md-6 text-center">
      <img src="<?php echo $banner_src; ?>" alt="<?php echo $banner_alt; ?>" class="content-section-1-banner">
    </div>
    <div class="col-md-6 align-middle">
      ...
      <div class="row content-section-1-author-img-p">
        <div class="col-3 text-center">
          <img tabindex="0" class="rounded-circle content-section-1-author" src="<?php echo $author_src; ?>" alt="Katlynn Sverko headshot">
        </div>
        <div class="col-9">
